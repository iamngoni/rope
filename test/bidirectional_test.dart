...
void main() {
  group('BidirectionalText Tests', () {
    ...
    test('Finds first strong directional character', () {
      // RTL first
      expect(BidirectionalText.findFirstStrongDirectional('שלום Hello'), equals(0));
      
      // LTR first
      expect(BidirectionalText.findFirstStrongDirectional('Hello שלום'), equals(0));
      
      // Neutral then RTL
      expect(BidirectionalText.findFirstStrongDirectional('123 שלום'), equals(4));
      
      // Neutral then LTR
      expect(BidirectionalText.findFirstStrongDirectional('123 Hello'), equals(4));
    ...
    test('Finds RTL segments correctly', () {
      ...
      final segments3 = BidirectionalText.findRtlSegments('Hello שלום World مرحبا');
